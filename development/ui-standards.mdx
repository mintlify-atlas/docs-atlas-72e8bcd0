...
description: "SansiStore enforces theme tokens for dark mode, Inter as the sole font, max-w-7xl layout width, and Lucide icons — never hardcoded Tailwind colors."
---
