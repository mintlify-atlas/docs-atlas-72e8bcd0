---
title: "Track and Manage Your SansiStore Orders"
sidebarTitle: "Orders"
description: "Buyers can view order history, check delivery status, and receive notifications at every step of the SansiStore order lifecycle."
---
...
<AccordionGroup>
  ...
  <Accordion title="PAGADO — Payment validated">
    Set by `paidOrder()` after the seller confirms receipt of payment. `stockTotal` and `stockReserved` are decremented in a transaction. Only deliverd orders can be moved to this status.
  </Accordion>
