...
The underlying API endpoint is `GET /api/admin/order_history?orderId=<id>`, which returns the full timeline for a single order including buyer, seller, items, payment, and delivery records.
