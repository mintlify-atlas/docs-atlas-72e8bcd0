---
title: "User Management and Role Assignment in SansiStore"
sidebarTitle: "Users"
description: "Admins manage user accounts, assign roles, enable or disable accounts, and review access logs for all SansiStore platform users."
---
...
Updates an existing user. Accepts `uid` (required) plus any subset of `displayName`, `email`, `phoneNumber`, `roles`, `isActive`. Updating `roles` also refreshes the Firebase Auth custom claims.
