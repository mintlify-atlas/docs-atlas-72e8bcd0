---
title: "Admin Dashboard: Monitor SansiStore Operations"
sidebarTitle: "Dashboard"
description: "The SansiStore admin dashboard provides KPIs, order summaries, seller activity, and courier session status in a single operations view."
---
