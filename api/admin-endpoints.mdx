---
title: "Admin API Endpoints Reference for SansiStore"
sidebarTitle: "Admin Endpoints"
description: "Server-side admin API routes for SansiStore: order history, orders list, courier sessions, top products, and user management."
---
...
<ResponseField name="users" type="array">
  ...
  - `internalPhone` — optional internal extension
