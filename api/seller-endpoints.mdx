---
title: "SansiStore Seller API Endpoints: Complete Reference"
sidebarTitle: "Seller Endpoints"
description: "Server-side seller API routes for SansiStore: retrieve pending orders and daily cash collection summaries for the authenticated vendedor role."
---
