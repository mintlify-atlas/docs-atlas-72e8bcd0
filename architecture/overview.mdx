...
<CardGroup cols={2}>
  ...
  <Card title="Cloud Firestore" icon="fire" href="https://firebase.google.com/docs/firestore">
    Real-time NoSQL database hosted in `southamerica-east1`. Houses 16 top-level collections (plus 2 subcollections) covering users, products, orders, deliveries, payments, inventory, and audit logs. See the [Data Model](/architecture/data-model) for full schemas.
  </Card>
